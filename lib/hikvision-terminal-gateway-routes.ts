...
import type { HikvisionTerminalGatewaySessionSnapshot } from "./hikvision-terminal-gateway-session";
import {
...
export async function readGatewaySupervisorStatus(
  deps: {
